 ...
 * Nombre de archivo: BeanProveedores.java
...
public class BeanProveedores extends BeanGeneric {
    private final static Logger log = Logger.getLogger(BeanProveedores.class);
    ...
    public void llenaProveedores() {
        try {
            ...
            dominio.setTipoPersona("p");
            List<DominioUsuarios> auxLista = new ArrayList<>();
            DominioUsuarios aux = new DominioUsuarios();
            aux.setIdUsuario(new Long(-1));
            aux.setNombre("");
            aux.setTipoPersona("");
            auxLista.add(aux);
            ...
            log.error("ERROR llenaProveedores : "+e);
        }
    }
    ...
    public void showProveedores(SelectEvent se) {
