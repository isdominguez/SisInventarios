 ...
 * Nombre de archivo: BeanClientes.java
...
public class BeanClientes extends BeanGeneric {
    private final static Logger log = Logger.getLogger(BeanClientes.class);
    ...
    public void llenaClientes() {
        try {
            ...
            log.error("ERROR llenaClientes : "+e);
        }
    }
    ...
    public void showClientes(SelectEvent se) {
