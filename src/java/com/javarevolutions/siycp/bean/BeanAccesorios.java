 ...
 * Nombre de archivo: BeanAccesorios.java
...
public class BeanAccesorios extends BeanGeneric {
    private final static Logger log = Logger.getLogger(BeanAccesorios.class);
