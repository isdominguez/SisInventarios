 ...
 * Nombre de archivo: DAOPagos.java
...
public interface DAOPagos extends DAOIfaceGeneric {
    List<Pagos> getListaPaginationByIdSeguimientoPago(int first, int pageSize, int idSeguimientoPago) throws Exception;
